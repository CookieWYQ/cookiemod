package com.cookiewyq.cookiemod.world.gen;
...
public class ModOreGeneration {
    ...
    private static ConfiguredFeature<?,?> registerOreFeature(OreType oreType,OreFeatureConfig oreFeatureConfig,ConfiguredPlacement configuredPlacement){
        return Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, Objects.requireNonNull(oreType.getBlock().get().getRegistryName()),
