package com.cookiewyq.cookiemod.world;

import com.cookiewyq.cookiemod.CookieMod;
import com.cookiewyq.cookiemod.world.gen.ModOreGeneration;
import com.cookiewyq.cookiemod.world.gen.ModOreGeneration;
    ...
    public static void addDimensionalSpacing(final WorldEvent.Load event) {
        if(event.getWorld() instanceof ServerWorld) {
            ...
            try {
                ...
                LogManager.getLogger().error("Was unable to check if {} is using Terraforged's ChunkGenerator.", serverWorld.getDimensionKey().getLocation());
            }
