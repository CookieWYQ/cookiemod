package com.cookiewyq.cookiemod.world.structure;

import com.cookiewyq.cookiemod.CookieMod;
import com.cookiewyq.cookiemod.world.structure.structures.HouseStructure;
...
public class ModStructures {
    public static final DeferredRegister<Structure<?>> STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, CookieMod.MOD_ID);
    public static final RegistryObject<Structure<NoFeatureConfig>> HOUSE = STRUCTURE.register("house", HouseStructure::new);
    ...
    public static <F extends Structure<?>> void setupMapSpacingAndLand(F structure, StructureSeparationSettings structureSeparationSettings,
        ...
        if (structure.getRegistryName() != null) {
            ...
            CookieMod.LOGGER.error("Structure {} has null registry name!", structure.getClass().getSimpleName());
        }
