...
public enum ModArmorMaterial implements IArmorMaterial {
    RICK("rick", 114, new int[]{9, 18, 24, 9}, 45, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 9.0F, 0.3F, () -> Ingredient.fromItems(ModItems.RICK_Ingot.get()));
    ...
    public String getName() {
        return CookieMod.MOD_ID + ":" + this.name;
    }
