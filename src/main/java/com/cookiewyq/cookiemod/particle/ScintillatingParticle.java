...
public class ScintillatingParticle extends SpriteTexturedParticle {
    protected ScintillatingParticle(ClientWorld world, double x, double y, double z, Vector3d speed, Color color, float diameter) {
